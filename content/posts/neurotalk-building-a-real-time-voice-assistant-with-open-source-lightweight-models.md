...
That is the high-level behavior. The rest of this article breaks down how each model is trained and how each stage is inferenced in the codebase.
...
The live loop is in [`backend/app/main.py`](https://github.com/nitishkmr005/neuroTalk/blob/main/backend/app/main.py):
...
The STT service lives in [`backend/app/services/stt.py`](https://github.com/nitishkmr005/neuroTalk/blob/main/backend/app/services/stt.py):
...
The defaults are defined in [`backend/config/settings.py`](https://github.com/nitishkmr005/neuroTalk/blob/main/backend/config/settings.py):
...
The debounce logic is in [`backend/app/main.py`](https://github.com/nitishkmr005/neuroTalk/blob/main/backend/app/main.py):
...
The whole LLM service is intentionally small. It lives in [`backend/app/services/llm.py`](https://github.com/nitishkmr005/neuroTalk/blob/main/backend/app/services/llm.py):
...
The corresponding defaults in [`backend/config/settings.py`](https://github.com/nitishkmr005/neuroTalk/blob/main/backend/config/settings.py) are:
...
This repo explicitly controls that second problem with a voice-oriented system prompt in [`backend/app/prompts/system.py`](https://github.com/nitishkmr005/neuroTalk/blob/main/backend/app/prompts/system.py).
...
That logic is in [`backend/app/main.py`](https://github.com/nitishkmr005/neuroTalk/blob/main/backend/app/main.py):
...
The live `TTSService` in [`backend/app/services/tts.py`](https://github.com/nitishkmr005/neuroTalk/blob/main/backend/app/services/tts.py) supports two code paths:
...
- [`backend/app/main.py`](https://github.com/nitishkmr005/neuroTalk/blob/main/backend/app/main.py)
- [`backend/app/services/stt.py`](https://github.com/nitishkmr005/neuroTalk/blob/main/backend/app/services/stt.py)
- [`backend/app/services/llm.py`](https://github.com/nitishkmr005/neuroTalk/blob/main/backend/app/services/llm.py)
- [`backend/app/services/tts.py`](https://github.com/nitishkmr005/neuroTalk/blob/main/backend/app/services/tts.py)
- [`backend/config/settings.py`](https://github.com/nitishkmr005/neuroTalk/blob/main/backend/config/settings.py)
- [`backend/app/prompts/system.py`](https://github.com/nitishkmr005/neuroTalk/blob/main/backend/app/prompts/system.py)
- [`backend/pyproject.toml`](https://github.com/nitishkmr005/neuroTalk/blob/main/backend/pyproject.toml)
